  ...
  describe("[ responses ]", () => {
    ...
    describe("parseResponse", () => {
      it("should parse response for DATA_MEASUREMENTS command type with valid date and time", () => {
        const hexResponse =
          "jiEAPAABAHcBaUEAEgAVAAAAAAoHCgIKAQn+Cf4J/gn+CfoJ+wn+CfwJ/Qn9Cf0J/QAAAAAAAAAAAAAJ/iggAAFcSQAFAAAAAAAyAAAAACgnoM4AAAAAAAsAAIDCAAAA3AABAAAAAAAAAAAAAAAAleUAAAAAAA8AFAEAADUAAAAAAJQAAAAAAAAAAAAA8A==";
